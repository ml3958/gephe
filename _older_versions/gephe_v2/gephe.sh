...
OPTIONS:
  ...
  COMMAND align:
    -c, --align_c   alignment coverage cutoff <default: 66>
...
do
    unset OPTIND
    unset OPTARG
    while getopts "hc:e:k:n:t:i:p:b:m:f:" opt; do
        case $opt in
            c ) ALIGNMENT_COVERAGE=$OPTARG ;;
...
export ALIGNMENT_COVERAGE=${ALIGNMENT_COVERAGE}
