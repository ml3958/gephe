...
export ALIGNMENT_NJOBS=${ALIGNMENT_NJOBS}
export N_FAA_TO_MERGE=${N_FAA_TO_MERGE}
...
export DIR_FAA=${DIR_ALIGNMENT_MASTER}/faa/   # dir for individual proteomes (INTERMEDIATE FILES)
export DIR_FAA_MERGE=${DIR_ALIGNMENT_MASTER}/faa_merge/   # dir for merged proteomes (INTERMEDIATE FILES)
export DIR_ALIGNMENT_MERGE=${DIR_ALIGNMENT_MASTER}/diamond_merge/  # dir for diamond output for merged proteome (INTERMEDIATE FILES)
export DIR_ALIGNMENT=${DIR_ALIGNMENT_MASTER}/diamond/  # divided diamond.out
